...
import { saveGeneratedScheduleV2 } from "@/lib/schedule-persistence";
...
import { makeV2SlotsForDayResolver } from "@/lib/v2/schedule-slots";
...
export default function DagitimIzlemePage() {
        ...
        window.setTimeout(() => {
          ...
          const result = autoSchedule(
            ...
            round + 1,
            {
              ...
              timing,
              slotsForDay: makeV2SlotsForDayResolver(v2.profiles),
            }
          );
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      const result = await saveGeneratedScheduleV2(
        supabase,
        best.lessons,
        organizationId
      );
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={() => router.push("/v2/dagitim")}
      ...
      {phase === "error" && (
        <div className="bg-red-50 border border-red-200 rounded-xl p-5 text-sm text-red-700">
          ...
          <div className="mt-3">
            <Link href="/v2/dagitim" className="underline font-medium">
              Kurallara dön
            </Link>
          </div>
        </div>
