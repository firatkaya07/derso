...
const DOWNLOADS: {
  ...
  },
  {
    ...
    description:
      "Tüm öğretmenlerin haftalık programı tek tabloda. Hücrelerde sınıf ve ders kısa adı; aynı sınıfa birden fazla ders giren öğretmenlerde dersler ayırt edilir.",
  ...
  },
  {
    ...
    description:
      "Her öğretmen için resmî yazı formatında ayrı sayfa. Program tablosu, toplam ders saati ve onay alanları.",
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-6 ml-7">
        Belge yeni sekmede açılır ve yazdırma penceresi çıkar; oradan
        &quot;PDF olarak kaydet&quot; seçebilirsiniz.
      </p>
                ...
                >
                  ...
                  <div className="mt-auto">
                    ...
                    >
                      ...
                      {isGenerating ? "Hazırlanıyor..." : "Yazdır / PDF Kaydet"}
                    </button>
                  </div>
                </div>
              );
